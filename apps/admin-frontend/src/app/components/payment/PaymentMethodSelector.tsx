...
import { CreditCard, Link2, Copy, Check, MessageSquare, Mail, Send, AlertCircle, Loader2, Sparkles, Smartphone } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {paymentMode === 'online_link' && (
        <div className="space-y-5 pt-2">
          ...
          {/* ── Generated Link Card ── */}
          {paymentLinkDetails && (
            <div className="bg-orange-50/80 border-2 border-orange-200 rounded-2xl p-5 space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="w-3 h-3 rounded-full bg-amber-500 animate-pulse"></span>
                  <span className="text-xs font-black text-amber-800 uppercase tracking-wider">Payment Link Generated</span>
                </div>
                <span className="text-[10px] font-extrabold uppercase px-2.5 py-1 bg-amber-100 text-amber-800 rounded-full border border-amber-300">
                  Pending Payment
                </span>
              </div>
              ...
              <p className="text-[11px] text-amber-700 italic text-center pt-1">
                🔒 Subscription will automatically activate immediately upon verified Razorpay webhook payment confirmation.
              </p>
            </div>
          )}
        </div>
